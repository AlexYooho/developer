package com.developer.payment.config;

import com.developer.framework.exception.CustomIdentityVerifyExceptionProcessor;
import com.developer.payment.converter.AccessTokenConvertor;
...
public class ResourceServerConfiger extends ResourceServerConfigurerAdapter {
    ...
    public void configure(ResourceServerSecurityConfigurer resources)  {
        resources.resourceId("developer_payment").tokenStore(tokenStore()).stateless(true).authenticationEntryPoint(customIdentityVerifyExceptionProcessor); // 添加自定义异常处理
    }
