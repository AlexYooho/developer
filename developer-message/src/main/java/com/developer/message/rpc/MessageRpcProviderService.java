...
public class MessageRpcProviderService implements MessageRpcService {
    ...
    public DeveloperResult<Boolean> sendFriendApplyAcceptMessage(Long receiverId) {
        return messageTypeProcessorDispatchFactory.getInstance(MessageConversationTypeEnum.PRIVATE_MESSAGE.code()).friendApplyAcceptMessage(receiverId);
    }
    ...
    public DeveloperResult<Boolean> sendFriendApplyRejectMessage(Long receiverId,String rejectReason) {
        return messageTypeProcessorDispatchFactory.getInstance(MessageConversationTypeEnum.PRIVATE_MESSAGE.code()).friendApplyRejectMessage(receiverId,rejectReason);
    }
    ...
    public DeveloperResult<Boolean> clearFriendChatMessage(Long friendId) {
        ...
        return messageTypeProcessorDispatchFactory.getInstance(MessageConversationTypeEnum.PRIVATE_MESSAGE.code()).deleteMessage(dto);
    }
    ...
    public DeveloperResult<Boolean> sendJoinGroupInviteMessage(SendJoinGroupInviteMessageRequestRpcDTO dto) {
        return messageTypeProcessorDispatchFactory.getInstance(MessageConversationTypeEnum.PRIVATE_MESSAGE.code()).sendJoinGroupInviteMessage(dto.getInviteMemberIds(),dto.getGroupName(),dto.getInviterName(),dto.getGroupAvatar());
    }
